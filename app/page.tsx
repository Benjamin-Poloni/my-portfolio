...
export default function Home() {
  return (
    <main className="text-white mx-auto py-40 w-full font-mono">
      ...
      <h2 className="text-xl my-2 ">Estudiante de Licencitura en Tecnologias De La Iformacion por UTEC.</h2>
      <section className="my-5">
      <p className="mb-3">Soy de Durazno, Uruguay. Me apasiona el desarrollo web, especialmente el desarrollo de aplicaciones back-end.</p>
