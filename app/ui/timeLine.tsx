...
import gitgubIcon from "@/public/icons/github-svgrepo-com.svg"
...
export default function TimeLine(){
    ...
    return(
        ...
        <div className="mt-10" id="about">
            <h3 className="mb-2 text-2xl">Hola</h3>
            ...
            {timelineData.slice().reverse().map((data,index)=>
             <li className="mb-10 ms-6" key={index}>            
                ...
                {data.link && (
                    <a href={data.link} target="_blank" className="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:outline-none focus:ring-gray-100 focus:text-blue-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 dark:focus:ring-gray-700">
                    {data.icon === 'github' &&(
                    ...
                    <span className="ml-2">{data.linkLabel}</span></a>
                )}
